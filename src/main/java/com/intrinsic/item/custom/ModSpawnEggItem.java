...
public class ModSpawnEggItem extends SpawnEggItem {
    ...
    public static RegistryObject<ModSpawnEggItem> createEgg(String name, RegistryObject<? extends EntityType<?>> entityTypeSupplier, int primaryColor, int secondaryColor) {
        return ModItems.ITEMS.register(name, () -> new ModSpawnEggItem(entityTypeSupplier, primaryColor, secondaryColor, new Item.Properties()));
    }
